...
public partial class AreaSceneBase : Node2D
{
    ...
    public Vector2 GetSpawnPoint(int spawnPointIndex)
    {
        ...
        return spawnPoint?.GlobalPosition ?? new(100, 100);
    }

    public void Init(HUDBase hud)
    {
        HUD = hud;
    ...
    private void SetNodeReferences()
    {
        ...
        CameraLimits = GetNode<Node2D>("CameraLimits");
    }
}
